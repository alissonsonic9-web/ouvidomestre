                ...
                <div className="p-8 bg-card text-card-foreground flex flex-col justify-center items-center text-center font-inter">
                    <p className="font-semibold text-foreground/50 text-xl relative">
                      <span className="absolute inset-0 flex items-center justify-center overflow-hidden">
                        <span className="block w-full h-1.5 bg-red-500 rotate-[-10deg] animate-draw-x-1 origin-center"></span>
                        <span className="block w-full h-1.5 bg-red-500 rotate-[10deg] animate-draw-x-2 origin-center"></span>
                      </span>
                      DE R$ 147,00
                    </p>
