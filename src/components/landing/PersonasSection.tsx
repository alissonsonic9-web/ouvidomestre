    ...
    <section id="personas" className="w-full py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-primary font-headline">Esse material é para você:</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {personas.map((persona, index) => (
                <Card key={index} className="bg-primary text-primary-foreground shadow-lg">
